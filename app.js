...
const copy = {
  cs: {
    ...
    "relevant.card1.title": "TCP/IP fundamentals",
    "relevant.card1.body": "IP addressing, DNS, ports, TCP vs UDP, basic routing",
    "relevant.card2.title": "VPN concepts",
    "relevant.card2.body": "SSL VPN, IPSec, certificates, MFA troubleshooting",
    "relevant.card3.title": "Authentication",
    "relevant.card3.body": "LDAP, SAML, RADIUS, OAuth/OIDC basics",
    "relevant.card4.title": "Endpoint & Windows",
    "relevant.card4.body": "services, Event Viewer, certificates, endpoint logs",
    "relevant.card5.title": "Packet analysis",
    "relevant.card5.body": "Wireshark, DNS/TCP/TLS observation in lab environments",
    "relevant.card6.title": "Databases",
    "relevant.card6.body": "SQL basics, semester coursework at VUT, data querying",
    "relevant.card7.title": "Case handling",
    "relevant.card7.body": "structured troubleshooting, documentation, customer communication",
    ...
    "skillcat.support.title": "Support & Troubleshooting",
    "skillcat.support.item1": "root cause analysis",
    "skillcat.support.item2": "log reading",
    "skillcat.support.item3": "reproduction steps",
    "skillcat.support.item4": "documentation",
    "skillcat.support.item5": "customer communication",
    "skillcat.network.title": "Networking & Security",
    "skillcat.network.item3": "VPN concepts",
    "skillcat.network.item5": "authentication basics",
    "skillcat.systems.title": "Systems & Tools",
    "skillcat.systems.item2": "Linux basics",
    "skillcat.dev.title": "Development & Data",
    "skillcat.dev.item4": "Django/Flask basics",
    ...
    "languages.de": "Němčina A2, aktivně zlepšuji",
    ...
    "project.pustovnickysmak.meta": "support relevance: user-facing web / practical delivery",
    "project.odkladiva.meta": "support relevance: hosting / troubleshooting / iteration",
    "project.pbtime.meta": "support relevance: deployment / debugging / documentation",
    "project.emulator.meta": "support relevance: hosting / debugging",
    "project.unity.meta": "support relevance: deployment / testing / practical delivery",
  ...
  en: {
    ...
    "intro.title": "Technical Support & Endpoint Security Candidate.",
    "intro.lead":
      "I combine web development, Python, database fundamentals, network diagnostics and practical problem solving. I am looking for a technical support / endpoint security support role where I can analyze logs, reproduce issues, communicate with customers and escalate clearly described cases.",
    "intro.cta": "Contact",
    "profile.eyebrow": "Profile",
    "profile.title": "Systematic troubleshooting instead of rushed patchwork.",
    "profile.body":
      "I present my profile honestly: a technical candidate with foundations in programming, databases, web projects, hands-on technical work and security learning labs. Calm diagnostics, documentation, communication and gradually building reliable systems fit me well.",
    "profile.card1.title": "Diagnostics",
    "profile.card1.body": "First I want to understand the symptom, environment, logs, reproduction path and impact.",
    "profile.card2.title": "Communication",
    "profile.card2.body": "I can translate a technical issue into clear steps for a customer or escalation.",
    "profile.card3.title": "Precision",
    "profile.card3.body": "I need time, context and tools to deliver accurate and maintainable solutions.",
    "relevant.eyebrow": "Endpoint support fit",
    "relevant.title": "Relevant for Endpoint Support.",
    "relevant.body":
      "Focused on foundations useful for endpoint security product support: networking, VPN, authentication, Windows diagnostics, logs, databases and structured case handling.",
    "relevant.card1.title": "TCP/IP fundamentals",
    "relevant.card1.body": "IP addressing, DNS, ports, TCP vs UDP, basic routing",
    "relevant.card2.title": "VPN concepts",
    "relevant.card2.body": "SSL VPN, IPSec, certificates, MFA troubleshooting",
    ...
    "relevant.card7.body": "structured troubleshooting, documentation, customer communication",
    "skills.eyebrow": "Skill matrix",
    "skills.title": "Skill matrix for support and troubleshooting.",
    "skills.body":
      "Practical foundation for incidents, logs, customer communication, network concepts and small tooling tasks.",
    "skillcat.support.title": "Support & Troubleshooting",
    "skillcat.support.item1": "root cause analysis",
    "skillcat.support.item2": "log reading",
    "skillcat.support.item3": "reproduction steps",
    ...
    "skillcat.dev.item4": "Django/Flask basics",
    "labs.eyebrow": "Security learning labs",
    "labs.title": "Security as defensive diagnostics.",
    "labs.body":
      "In my own controlled lab environments I learned to analyze network traffic with Wireshark, understand ARP/DNS/TCP behavior, common security weaknesses and attack principles from the perspective of defense, diagnostics and prevention.",
    "why.eyebrow": "Why endpoint support",
    "why.title": "Why endpoint support.",
    "why.body":
      "I enjoy finding root causes, working with logs, security topics, communication between technical and non-technical people and learning products in depth. I want to help improve systems gradually and precisely.",
    "languages.en": "English B2",
    "languages.de": "German A2, actively improving",
    ...
    "contact.title": "Open to Technical Support, Endpoint Security Support, Application Support and Junior Cybersecurity Troubleshooting roles.",
    "contact.body":
      "I prefer roles where precise diagnostics, customer communication, log work and technically closing cases properly matter.",
    "contact.listTitle": "What I can bring",
    "contact.item1": "log analysis and structured troubleshooting steps",
    "contact.item2": "clear communication with customers and technicians",
    "contact.item3": "documentation, procedures and process thinking",
    "contact.item4": "AI-assisted workflow without replacing real understanding",
